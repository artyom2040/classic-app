...
export const COMPOSER_PORTRAITS: Record<string, string> = {
  ...
  handel: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/George_Frideric_Handel_by_Balthasar_Denner.jpg/220px-George_Frideric_Handel_by_Balthasar_Denner.jpg',
  
  // Classical
  mozart: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Wolfgang-amadeus-mozart_1.jpg/220px-Wolfgang-amadeus-mozart_1.jpg',
  haydn: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Joseph_Haydn.jpg/220px-Joseph_Haydn.jpg',
  
  // Romantic
  beethoven: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Beethoven.jpg/220px-Beethoven.jpg',
  ...
  chopin: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Frederic_Chopin_photo.jpeg/220px-Frederic_Chopin_photo.jpeg',
  liszt: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Franz_Liszt_1858.jpg/220px-Franz_Liszt_1858.jpg',
  brahms: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/JohannesBrahms.jpg/220px-JohannesBrahms.jpg',
  tchaikovsky: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Portr%C3%A4t_des_Komponisten_Pjotr_I._Tschaikowski_%281840-1893%29.jpg/220px-Portr%C3%A4t_des_Komponisten_Pjotr_I._Tschaikowski_%281840-1893%29.jpg',
  ...
  debussy: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Claude_Debussy_ca_1908%2C_foto_av_F%C3%A9lix_Nadar.jpg/220px-Claude_Debussy_ca_1908%2C_foto_av_F%C3%A9lix_Nadar.jpg',
  ...
  // 20th Century
  stravinsky: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Igor_Stravinsky_LOC_32392u.jpg/220px-Igor_Stravinsky_LOC_32392u.jpg',
...
export const ERA_IMAGES: Record<string, string> = {
  baroque: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Palace_of_Versailles%2C_April_2011.jpg/320px-Palace_of_Versailles%2C_April_2011.jpg',
  classical: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Konzerthaus_Berlin_-_Grosser_Saal.jpg/320px-Konzerthaus_Berlin_-_Grosser_Saal.jpg',
  romantic: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg/240px-Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg',
  modern: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Tsunami_by_hokusai_19th_century.jpg/300px-Tsunami_by_hokusai_19th_century.jpg',
  contemporary: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Walt_Disney_Concert_Hall%2C_LA%2C_CA%2C_jjron_22.03.2012.jpg/320px-Walt_Disney_Concert_Hall%2C_LA%2C_CA%2C_jjron_22.03.2012.jpg',
};

// Helper to get composer portrait with fallback
export function getComposerPortrait(composerId: string): string | null {
  return COMPOSER_PORTRAITS[composerId.toLowerCase()] || null;
}

// Helper to get era image
export function getEraImage(periodId: string): string | null {
